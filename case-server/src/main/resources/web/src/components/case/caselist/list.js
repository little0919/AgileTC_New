  ...
  setColumns = () => {
    const columns = [
      ...
      },
      {
        ...
        width: '25%',
        render: (text, record) => {
          console.log('点击用力', this.props.caseKeywords);
          let url = ''
          if(this.props.caseKeywords){
            url = `${this.props.baseUrl}/caseManager/${this.props.productId}/${record.id}/undefined/0/${this.props.caseKeywords}`;
          }else{
