...
class CaseLists extends React.Component {
  ...
  setCaseFileterText = (text) => {
    console.log('用例关键词',text);
    this.setState({caseKeywords: text})
  }
        ...
        <div className="min-hig-content">
          <div className="site-drawer-render-in-current-wrapper">
            ...
            <List
              ...
              caseKeywords={this.state.caseKeywords}
            ></List>
            ...
            {(filterVisble && (
              <OeFilter
                ...
                oeApiPrefix={this.props.oeApiPrefix}
                productId={productLineId}
                setCaseFileterText={this.setCaseFileterText}
              />
            )) ||
              null}
          </div>
